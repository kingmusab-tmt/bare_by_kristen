...
const ContactUs = () => {
  return (
    <div className="pt-24 bg-gradient-to-r from-purple-500 to-pink-500 p-10 shadow-lg rounded-lg transform transition duration-500 hover:scale-105">
      <Head>
        <title>
      ...
      <ul className="text-white mt-4 ml-4 list-disc">
